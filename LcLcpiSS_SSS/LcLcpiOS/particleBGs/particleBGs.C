...
void particleBGs(){
    ...
    auto h1 = df2.Histo1D({"pion-pion background", "pion-pion background", 50, 200, 3000}, "inv_mass_pion_pion");
    auto h2 = df2.Histo1D({"proton-kaon background", "proton-kaon background", 40, 1400, 3000}, "inv_mass_proton_kaon");
    auto h3 = df2.Histo1D({"proton-pion background", "proton-pion background", 40, 1000, 3000}, "inv_mass_proton_pion");
    auto h4 = df2.Histo1D({"kaon-pion background", "kaon-pion background", 40, 600, 3000}, "inv_mass_kaon_pion");
    auto h5 = df2.Histo1D({"kaonm-kaonp background", "kaonm-kaonp background", 60, 900, 2500}, "inv_mass_kaonm_kaonp");
    auto h6 = df2.Histo1D({"pKmpim background", "pKmpim background", 40, 1800, 4000}, "inv_mass_pKmpim");

    TCanvas* c1 = new TCanvas("c1", "c1", 800, 600);
    h1->SetTitle("Invariant mass of pion-pion pairs");
    ...
    h2->SetTitle("Invariant mass of proton-kaon pairs");
    ...
    h3->SetTitle("Invariant mass of proton-pion pairs");
    ...
    h4->SetTitle("Invariant mass of kaon-pion pairs");
    ...
    h5->SetTitle("Invariant mass of kaonm-kaonp pairs");
    ...
    h6->SetTitle("Invariant mass of pKmpim pairs");
