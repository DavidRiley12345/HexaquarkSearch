...
tin = fin.Get('B2LcLcpiSS/DecayTree')
...
graph.SetTitle("Purity with Prob {} cut (SS);Cut Value;Purity".format(pid))
...
graph.SetTitle("Significance with Prob {} cut (SS);Cut Value;Significance".format(pid))
graph.SetMarkerStyle(0)
graph.Draw()
